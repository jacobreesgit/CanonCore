- if you need to, use claude.md, and the mcp servers: sequential thinking, context7, neon, and shadcn to ensure best pratice. also if you like, use skills, e..g, front-end design skill or the superpower skills.
