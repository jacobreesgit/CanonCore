/**
 * Shared type definitions for CanonCore.
 *
 * Platform-agnostic types consumed by both web and mobile apps.
 * dnd-kit and React-specific types are replaced with standalone equivalents.
 */

import type { FileType, SyncStatus, SystemPlaylistType } from "@prisma/client";

// Re-export Prisma enums for client-side use
export { SyncStatus, FileType, SystemPlaylistType } from "@prisma/client";

/**
 * Unique identifier type for tree items.
 * Standalone equivalent of @dnd-kit/core UniqueIdentifier.
 */
 ...
 */
export type SensorContext = { current: { items: FlattenedItem[]; offset: number } };
